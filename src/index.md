...
<img class="lead-img" src="/static/images/Slussbild_009.jpg" alt="Sicklaslussen">
...
{% for post in collections.news | reverse | limit(3) %}
  <li>
    <h3 class="news-title"><a href="{{ post.url }}">{{ post.data.title }}</a></h3>
...
<p class="readmore"><a href="/nyheter/">&gt;&gt; Fler nyheter ...</a></p>